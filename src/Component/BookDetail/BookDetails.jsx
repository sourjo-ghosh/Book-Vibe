    ...
    <div className="md:px-14 md:py-5">
      <div className=" overflow-hidden rounded-4xl bg-white shadow-[0_30px_80px_rgba(0,0,0,0.08)]">
        <div className="md:flex">
          <div className="md:w-5/12 bg-[#F8FAFC] p-6 md:p-5 flex items-center justify-center">
            <img
              src={book.image}
              alt={book.bookName}
          ...
          <div className="md:w-7/12 p-3 md:p-12 rounded-2xl">
            <div className="flex flex-col gap-6 md:gap-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <button className="inline-flex w-full items-center justify-center rounded-2xl bg-[#111827] px-8 py-4 text-base font-semibold text-white transition hover:bg-[#1f2937] sm:w-auto cursor-pointer">
                  Read
                </button>
